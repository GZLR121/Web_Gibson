...
<body>
  ...
  <div class="content">
    <section class="Articulo">
      <h1>Gibson J-45</h1>
      <img src="https://www.gitarrentotal.ch/wp-content/uploads/2019/05/GibsonJ-45StandardCherryLimitedRun2019-1.jpg"
        alt="J-45">
      ...
      <div class="txtArticulo">
        ...
        <h3>Historia</h3><br>
        <ul>
          <li>La guitarra J-45 fue creada a mediados de la década de 1940.</li><br>
          <li>El diseño original de la J-45 se basó en la exitosa guitarra Jumbo de Gibson.</li><br>
          <li>La J-45 fue lanzada en 1942 y rápidamente se convirtió en una de las guitarras acústicas más populares de
            Gibson.</li>
        </ul>
      </div>
    ...
    <section class="ArticuloExtras">
      <h2>Estructura</h2>
      <img src="https://www.gitarrentotal.ch/wp-content/uploads/2020/07/Gibson60sJ-45OriginalWineRed-1.jpg"
        alt="J-45 Layout">
      <div class="txtArticuloExtras">
        <h3>Características</h3><br>
        <ul>
          <li>Cuerpo: Las J-45 tienen un cuerpo dreadnought grande hecho de caoba. La caoba les da un sonido cálido y
            grueso, con mucho sustain.</li>
          <br>
          <li>Pastillas: Las J-45 no vienen con pastillas de fábrica, pero se pueden equipar con pastillas opcionales
            para amplificación.</li><br>
          <li>Puente: Las J-45 tienen un puente Tune-o-matic con un cordal fijo. Esto les da una excelente estabilidad
            de afinación.</li><br>
          <li>Mástil: Las J-45 tienen un mástil de caoba con un diapasón de palo de rosa. El diapasón de palo de rosa es
            conocido por su tacto suave y su tono cálido.</li><br>
        </ul>

        <h3>Sonido</h3><br>
        <p>Las guitarras J-45 son conocidas por su sonido cálido, rico y con mucho sustain. Son perfectas para una
