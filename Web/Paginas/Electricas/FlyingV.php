  ...
  <nav>
    ...
    <div class="content">
        <section class="Articulo">
            <h1>Gibson Flying V</h1>
            <img src="https://www.gitarrentotal.ch/wp-content/uploads/2022/05/GibsonFlying-VDaveMustaineSilverMetallic-1-scaled.jpg"
                alt="Flying V">

            <div class="txtArticulo">
                <h3>Descripción</h3><br>
                <p>Las guitarras Flying V de Gibson son instrumentos únicos y llamativos que se han convertido en un
                    símbolo del rock and roll. Con su diseño en forma de "V" y su sonido potente, las Flying V han sido
                    utilizadas por algunos de los guitarristas más legendarios de la historia, como Albert King, James
                    Hetfield, Jimi Hendrix, Dave Mustaine y muchos más.</p><br>

                <h3>Historia</h3><br>
                <ul>
                    <li>La Gibson Flying V fue diseñada a finales de la década de 1950 por Alvino "Al" Pee Wee Cray, un
                        diseñador de Gibson.</li><br>
                    <li>El diseño original de Cray era aún más radical que la Flying V que conocemos hoy en día. Gibson
                        modificó el diseño y lanzó la Flying V en 1958.</li><br>
                    <li>La Flying V no fue un éxito inmediato en su lanzamiento, pero se ganó un culto después a lo
        ...
        <section class="ArticuloExtras">
            <h2>Estructura</h2>
            <img src="https://i.pinimg.com/originals/98/69/1c/98691c46a10341d260bea7439d159f50.jpg"
                alt="Explorer Layout">
            <div class="txtArticuloExtras">
                <h3>Características</h3><br>
                <ul>
                    <li>Cuerpo: Las Flying V tienen un cuerpo sólido hecho de caoba o korina. El cuerpo de caoba les da
                        un sonido cálido y grueso, mientras que el cuerpo de korina les da un sonido más brillante y con
                        más pegada.</li><br>
                    <li>Pastillas: Las Flying V generalmente vienen con dos pastillas humbucker. Las pastillas humbucker
                        son conocidas por su sonido potente y con mucho cuerpo.</li><br>
                    <li>Puente: Las Flying V tienen un puente Tune-o-matic con un cordal fijo. Esto les da una excelente
                        estabilidad de afinación.</li><br>
                    <li>Mástil: Las Flying V tienen un mástil de caoba con un diapasón de palo de rosa. El diapasón de
                ...
                <video controls>
                    <source src="/Web_Gibson/Web/videos/Flying V Dave Mustaine.mp4" type="video/mp4">
                </video>
            </div>
        </section>
